...
import com.androsa.nifty.entity.renderer.*;
...
public class ModEntities {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITIES = DeferredRegister.create(ForgeRegistries.ENTITIES, NiftyMod.MODID);
