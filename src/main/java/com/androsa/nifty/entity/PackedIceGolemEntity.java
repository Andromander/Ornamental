...
import com.androsa.nifty.entity.projectile.PackedIceEntity;
...
public class PackedIceGolemEntity extends IceGolemEntity implements IRangedAttackMob {
    ...
    public void attackEntityWithRangedAttack(LivingEntity entity, float multiplier) {
        PackedIceEntity snowballentity = new PackedIceEntity(ModEntities.PACKED_ICEBALL.get(), this.world, this);
