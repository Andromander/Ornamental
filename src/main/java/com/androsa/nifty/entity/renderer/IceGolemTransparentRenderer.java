...
public class IceGolemTransparentRenderer<T extends IceGolemEntity> extends IceGolemRenderer<T> {
    ...
    public static final ResourceLocation texIce = new ResourceLocation(NiftyMod.MODID, "textures/entity/ice_golem_body.png");
    public static final ResourceLocation texGolem = new ResourceLocation(NiftyMod.MODID, "textures/entity/ice_golem.png");
