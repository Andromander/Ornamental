...
public class RedstoneGolemModel<T extends RedstoneGolemEntity> extends AbstractGolemModel<T> {
    ...
    public RedstoneGolemModel() {
        ...
        this.legL2.addCuboid(0.0F, -1.0F, -1.0F, 12, 2, 2, 0.0F);
        ...
        this.body2.addCuboid(-3.0F, -8.0F, -3.0F, 6, 8, 6, 0.0F);
        ...
        this.legL1.addCuboid(0.0F, -1.0F, -1.0F, 12, 2, 2, 0.0F);
        ...
        this.legR2.addCuboid(0.0F, -1.0F, -1.0F, 12, 2, 2, 0.0F);
