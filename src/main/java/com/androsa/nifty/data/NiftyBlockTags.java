...
import com.androsa.nifty.data.provider.NiftyBlockTagProvider;
...
public class NiftyBlockTags extends NiftyBlockTagProvider {
    ...
    public NiftyBlockTags(DataGenerator generator) {
        super(generator);
    }
