...
public class ModEntities {
    ...
    public static final Supplier<EntityType<EmeraldGolem>> EMERALD_GOLEM = makeEntity("emerald", EmeraldGolem::new, 1.3F, 2.6F, 2.2F, false, 3728178, 4364136);
    public static final Supplier<EntityType<LapisGolem>> LAPIS_GOLEM = makeEntity("lapis", LapisGolem::new, 1.2F, 2.3F, 2.1F, false, 1983113, 2239809);
    public static final Supplier<EntityType<ObsidianGolem>> OBSIDIAN_GOLEM = makeEntity("obsidian", ObsidianGolem::new, 2.0F, 2.9F, 2.7F, true, 1577769, 1975353);
    public static final Supplier<EntityType<CoalGolem>> COAL_GOLEM = makeEntity("coal", CoalGolem::new, 0.9F, 2.0F, 1.9F, false, 1839891, 8275712);
    public static final Supplier<EntityType<RedstoneGolem>> REDSTONE_GOLEM = makeEntity("redstone", RedstoneGolem::new, 0.8F, 1.8F, 1.8F, false, 7285799, 14819374);
    ...
    public static final Supplier<EntityType<PackedIceGolem>> PACKED_ICE_GOLEM = makeEntity("packed_ice", PackedIceGolem::new, 0.7F, 1.9F, 1.7F, false, 8168948, 4155339);
    public static final Supplier<EntityType<BlueIceGolem>> BLUE_ICE_GOLEM = makeEntity("blue_ice", BlueIceGolem::new, 0.7F, 1.9F, 1.7F, false, 7646206, 3301070);
