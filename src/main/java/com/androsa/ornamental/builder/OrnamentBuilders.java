...
public class OrnamentBuilders {
    ...
    public static final OrnamentBuilder CUT_COPPER = new OrnamentBuilder("cut_copper")
            .mapColor(MapColor.COLOR_ORANGE)
            .hardnessAndResistance(3.0F, 6.0F)
            .requiresTool()
            .stairBaseBlock(() -> Blocks.COPPER_BLOCK)
            .saddledoorSounds(SoundEvents.COPPER_TRAPDOOR_OPEN, SoundEvents.COPPER_TRAPDOOR_CLOSE)
            .blockSetType(new BlockSetBuilder("cut_copper")
                    .openByHand()
                    .openByBreeze()
                    .soundType(SoundType.COPPER)
                    .doorSounds(SoundEvents.COPPER_DOOR_CLOSE, SoundEvents.COPPER_DOOR_OPEN)
    ...
    public static final OrnamentBuilder EXPOSED_CUT_COPPER = new OrnamentBuilder("exposed_cut_copper")
            ...
            .stairBaseBlock(() -> Blocks.EXPOSED_COPPER)
            .saddledoorSounds(SoundEvents.COPPER_TRAPDOOR_OPEN, SoundEvents.COPPER_TRAPDOOR_CLOSE)
            .blockSetType(new BlockSetBuilder("exposed_cut_copper")
                    .openByHand()
                    .openByBreeze()
                    .soundType(SoundType.COPPER)
                    .doorSounds(SoundEvents.COPPER_DOOR_CLOSE, SoundEvents.COPPER_DOOR_OPEN)
    ...
    public static final OrnamentBuilder WEATHERED_CUT_COPPER = new OrnamentBuilder("weathered_cut_copper")
            ...
            .stairBaseBlock(() -> Blocks.WEATHERED_COPPER)
            .saddledoorSounds(SoundEvents.COPPER_TRAPDOOR_OPEN, SoundEvents.COPPER_TRAPDOOR_CLOSE)
            .blockSetType(new BlockSetBuilder("weathered_cut_copper")
                    .openByHand()
                    .openByBreeze()
                    .soundType(SoundType.COPPER)
                    .doorSounds(SoundEvents.COPPER_DOOR_CLOSE, SoundEvents.COPPER_DOOR_OPEN)
    ...
    public static final OrnamentBuilder OXIDIZED_CUT_COPPER = new OrnamentBuilder("oxidized_cut_copper")
            ...
            .stairBaseBlock(() -> Blocks.OXIDIZED_COPPER)
            .saddledoorSounds(SoundEvents.COPPER_TRAPDOOR_OPEN, SoundEvents.COPPER_TRAPDOOR_CLOSE)
            .blockSetType(new BlockSetBuilder("oxidized_cut_copper")
                    .openByHand()
                    .openByBreeze()
                    .soundType(SoundType.COPPER)
                    .doorSounds(SoundEvents.COPPER_DOOR_CLOSE, SoundEvents.COPPER_DOOR_OPEN)
