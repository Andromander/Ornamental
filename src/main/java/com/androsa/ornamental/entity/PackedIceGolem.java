...
public class PackedIceGolem extends IceGolem implements RangedAttackMob {

    public PackedIceGolem(EntityType<? extends PackedIceGolem> entity, Level world) {
        super(entity, world);
        canMelt = false;
    }
    ...
    protected void registerGoals() {
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Mob.class, 10, true, false, (target, server) ->
    ...
    public void performRangedAttack(LivingEntity entity, float multiplier) {
        PackedIce snowball = new PackedIce(ModEntities.PACKED_ICEBALL.get(), this.level(), this);
        ...
        snowball.shoot(d1, d2 + f, d3, 1.6F, 12.0F);
