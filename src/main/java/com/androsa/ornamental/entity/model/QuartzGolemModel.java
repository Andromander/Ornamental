...
public class QuartzGolemModel<T extends QuartzGolemEntity> extends AbstractGolemModel<T> {
    ...
    public QuartzGolemModel() {
        ...
        this.tail1.setPos(0.0F, 3.0F, 0.0F);
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.tail1.xRot = MathHelper.sin(ageInTicks * 0.067F) * 0.1F + 0.3490658503988659F;
        this.tail2.xRot = MathHelper.sin(ageInTicks * 0.067F) * 0.1F + 0.3490658503988659F;
        this.tail3.xRot = MathHelper.sin(ageInTicks * 0.067F) * 0.1F + 0.3490658503988659F;
    }
